...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './strategy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRATEGY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRATEGY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRATEGY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STRATEGY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STRATEGY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRATEGY actions', async () => {
      const arg = 42666;
