...
export const ProjectDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/app1/project${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="app1App.app1Project.delete.question">
        <Translate contentKey="app1App.app1Project.delete.question" interpolate={{ id: projectEntity.id }}>
