...
export const CustomerDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.app1.customer.updateSuccess);

  const handleClose = () => {
    navigate('/app1/customer');
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="app1App.app1Customer.delete.question">
        <Translate contentKey="app1App.app1Customer.delete.question" interpolate={{ id: customerEntity.id }}>
