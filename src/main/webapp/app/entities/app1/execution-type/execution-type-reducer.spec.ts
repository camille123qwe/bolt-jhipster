...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXECUTIONTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXECUTIONTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXECUTIONTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXECUTIONTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXECUTIONTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXECUTIONTYPE actions', async () => {
      const arg = 42666;
